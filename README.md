...
- Exibição das senhas na tela principal  
- Tela do atendente para chamar próxima senha  
...
- **TypeScript**
- **HTML / SCSS**
- Armazenamento local (variáveis ou SQLite, conforme orientações do PDF)
...
### Tela Principal
- Exibir última senha chamada
- Acessar telas de gerenciamento

###  Tela de Gerenciamento / Atendente
- Digitar número do guichê
- Botões:
  - **Chamar próximo**
